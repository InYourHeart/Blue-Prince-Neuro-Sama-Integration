...
namespace Blue_Prince_Neuro_Sama_Integration_Mod.src.Actions
{
	public class PickBerryAction : MiscAction
	{
		...
		protected override string Description => "Draft a random floor plan disregarding rarity using the Blessing of the Berry Picker's drafting ability. It costs 1 wild berry.";
	}
}
